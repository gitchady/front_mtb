...
export const PLANET_ACTIONS: Record<PlanetCode, PlanetAction[]> = {
  ORBIT_COMMERCE: [
    {
      id: "orbit_partner",
      title: "Запустить партнерский сигнал",
      detail: "Отправляет партнерский импульс в живой контур синхронизации и открывает окно бустера",
      eventKind: "partner",
      stardustReward: 6,
    },
    {
      id: "orbit_open",
      title: "Запустить свободный сигнал",
      detail: "Поддерживает общий ритм активности без сильного разгона партнерской линии",
  ...
  CREDIT_SHIELD: [
    {
      id: "shield_payment",
      title: "Выдержать ритм щита",
      detail: "Укрепляет щит, двигает прогресс вверх и закрепляет устойчивое поведение",
      eventKind: "credit",
      stardustReward: 7,
    },
    {
      id: "shield_learning",
      title: "Пройти учебный модуль",
      detail: "Активирует образовательный сценарий и открывает более устойчивую траекторию прогресса",
      eventKind: "education",
      stardustReward: 4,
    },
  ],
  SOCIAL_RING: [
    ...
    },
    {
      ...
      detail: "Запускает рискованное событие, чтобы увидеть записи на проверке и флаги риска в реальном времени",
      eventKind: "risky",
      stardustReward: 2,
    },
  ],
