...
const SEGMENTS = [
  {
    id: "student",
    title: "Студент",
    detail: "Быстрый рост, простые циклы и усиления за повседневные партнерские сигналы.",
  },
  {
    id: "first-jobber",
    title: "Первый доход",
    detail: "Сбалансированный прогресс с акцентом на рост доступа и устойчивый ритм.",
  },
  {
    id: "freelancer",
    title: "Фрилансер",
